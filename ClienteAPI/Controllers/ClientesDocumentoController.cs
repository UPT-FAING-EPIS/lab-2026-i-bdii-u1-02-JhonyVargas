...
namespace ClienteAPI.Controllers
{
    ...
    [ApiController]
    public class ClientesDocumentoController : ControllerBase
    {
        private readonly BdClientesContext _context;

        public ClientesDocumentoController(BdClientesContext context)
        {
            _context = context;
        }

        // GET: api/ClientesDocumento
        [HttpGet]
        ...
        // DELETE: api/ClientesDocumento/5/1
